...
<div class="panel panel-default panel-border-color panel-border-color-primary">
  <div class="panel-heading panel-heading-divider">Edit Member Position</div>
    ...
    <form id="form_blog">
      ...
      <div class="row xs-pt-15">
        <div class="col-xs-6 pull-right mr-10">
          <p class="text-right">
            <button type="submit" class="btn btn-space btn-primary" id="update_member_position">Update</button>
            <button class="btn btn-space btn-default" id="cancel_position_update">Cancel</button>
          </p>
        </div>
      </div>
    </form>
...
<script>
  ...
  $('#cancel_position_update').off('click').on('click', function(e){
    e.preventDefault();
    organization();
  });
