  ...
  <div class="panel-body">
    <div class="col-md-12">
      <div class="user-display mb-10">
        <div class="user-display-bg" style="max-height: 400px;"><img src="{{"/images/".$cause->file_name?:'/img/gallery/img11.jpg'}}" alt="Profile Background"></div>
        <div class="user-display-bottom">
          <div class="user-display-avatar"><img src="{{"/images/".$cause->file_name?:'/img/gallery/img11.jpg'}}" alt="Avatar"></div>
          <div class="user-display-info">
            <div class="name">
              {{$cause->title}} 
              <span class="icon mdi mdi-money-box mr-5 cause_donation pull-right pointer" data-url="/cause/donation" style="color: #e72919;"></span>
          ...
          <div class="row user-display-details">
            <div class="col-xs-4" style="border-right: 3px solid #ccc;">
              ...
              <div class="counter">$ {{$cause->goal}}</div>
            </div>
            <div class="col-xs-4" style="border-right: 3px solid #ccc;">
    ...
    <div class="col-md-12 mt-15">
      <div class="panel panel-default" style="border-top: 3px solid #ccc;">
        ...
        <div class="panel-body">
        @foreach($cause->causeComments() as $comment)
          <div class="timeline-content mt-15">
            <div class="timeline-avatar"><img src="{{"/images/".$cause->file_name?:'/img/gallery/img11.jpg'}}" alt="Avatar" class="circle">
            </div>
            ...
            <div class="timeline-content mt-15">
              <div class="timeline-avatar"><img src="{{"/images/".$cause->file_name?:'/img/gallery/img11.jpg'}}" alt="Avatar" class="circle"></div>
              <div class="timeline-header">
                <span class="timeline-time">
...
<script>
  ...
  function causeDeatail(){
    let url = '/backend/cause/detail/{{$cause->id}}';
    $.ajax({
        method:'get',
        url:url,
