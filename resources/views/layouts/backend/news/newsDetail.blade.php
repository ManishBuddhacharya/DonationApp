  ...
  <div class="panel-body">
    <div class="col-md-12">
      <div class="user-display mb-10">
        <div class="user-display-bg" style="max-height: 400px;"><img src="{{"/images/".$news->file_name?:'/img/gallery/img11.jpg'}}" alt="Profile Background"></div>
        <div class="user-display-bottom">
          <div class="user-display-avatar"><img src="{{"/images/".$news->file_name?:'/img/gallery/img11.jpg'}}" alt="Avatar"></div>
          <div class="user-display-info">
            <div class="name">
              {{$news->title}} 
              <span class="icon mdi mdi-delete mr-5 story_delete pull-right pointer" data-url="/backend/news/delete/{{$news->id}}" style="color: #e72919;"></span>
              <span class="icon mdi mdi-edit mr-5 story_edit pull-right pointer" data-url="/backend/news/edit/{{$news->id}}" style="color: #4285f4;"></span>
            </div>
            <div class="nick"><span class="mdi mdi-account"></span> {{$news->user()->name}} </div>
          </div>
        </div>
      </div>  
    </div>
      ...
      <div class="panel panel-default" style="border-top: 3px solid #ccc;">
        ...
        @foreach($news->newsComments() as $comment)
          <div class="timeline-content mt-15">
            <div class="timeline-avatar"><img src="{{"/images/".$news->file_name?:'/img/gallery/img11.jpg'}}" alt="Avatar" class="circle">
            </div>
            ...
            <div class="timeline-content mt-15">
              <div class="timeline-avatar"><img src="{{"/images/".$news->file_name?:'/img/gallery/img11.jpg'}}" alt="Avatar" class="circle"></div>
              <div class="timeline-header">
                <span class="timeline-time">
...
<script>
  ...
  function newsDeatail(){
    let url = '/backend/news/detail/{{$news->id}}';
    $.ajax({
        method:'get',
        url:url,
